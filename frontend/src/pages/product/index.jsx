            ...
            <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-10 py-6 sm:py-8">
              ...
              <div className="mb-8 space-y-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-2xl sm:text-3xl font-black text-white tracking-tight drop-shadow-lg leading-none">Products</h1>
                  ...
                  <div className="flex items-center gap-3 overflow-x-auto pb-2 -mx-2 px-2 scrollbar-hide">
                    <div className="relative group">
                      ...
                      <select
                        ...
                        className="pl-8 pr-4 py-3 bg-white/5 border border-white/[0.08] rounded-xl text-white text-[12px] font-black uppercase tracking-widest appearance-none focus:outline-none focus:border-yellow-400/40 transition-all"
                      >
                    ...
                    <button onClick={() => setShowSearchModal(true)} className="px-5 py-3 bg-gradient-to-r from-yellow-500 to-amber-500 hover:from-yellow-400 hover:to-amber-400 text-[#071428] font-black uppercase tracking-widest text-[12px] rounded-xl shadow-xl transition-all flex items-center justify-center gap-2 whitespace-nowrap active:scale-95">
                      <Globe size={14} /> Search Global
                    </button>

                    <button
                      onClick={() => { resetForm(); setShowModal(true); }}
                      className="px-8 py-3 bg-gradient-to-r from-yellow-500 to-amber-500 hover:from-yellow-400 hover:to-amber-400 text-slate-900 font-black uppercase tracking-widest text-[12px] rounded-xl shadow-2xl transition-all flex items-center justify-center gap-2 whitespace-nowrap border border-white/10"
                    >
                                  ...
                                  >
                                    ...
                                    <td className="px-8 py-5">
                                      <div className="flex flex-col items-center gap-2">
                                        ...
                                        <span className={`text-[8px] font-black uppercase tracking-widest transition-colors ${p.status === 1 ? 'text-yellow-400' : 'text-white/30'}`}>
